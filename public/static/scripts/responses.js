function getBotResponse(input,step) {
    ...
    switch (step) {
        case 1:
            return "<label for='latitude'>Latitude</label><input type='number' id='lat' name='lat' ><label for='logitudinal'>Logidunal</label><input type='number' id='log' name='log' ><button type='submit' value='submit' onclick='latitude()'>Submit</button>"; 
            break;
        case 2:
            return "<iframe style='border-color: black; border-width: 5px;height: 175px; width: 240px' id='mapid' src='/map' title='W3Schools Free Online Web Tutorials'></iframe><button type='submit' value='submit' onclick='mapnext()'>Next</button>";             
            break;
        case 3:
